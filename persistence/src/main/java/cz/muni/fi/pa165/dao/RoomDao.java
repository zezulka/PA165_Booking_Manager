...
public interface RoomDao {
    ...
    /**
     * Creates a new {@link Room}. The argument passed must not be null and its
     * id must be set to null.
     *
    ...
    /**
     * Updates an existing {@link Room} and returns the instance relevant to the
     ...
     *
     * @return A {@link List} of all rooms, an empty {@link List} if there are
     * none.
     */
